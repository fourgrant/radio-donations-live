Rails.application.configure do
  ...
  # Disabled: tailwind.css is pre-minified and old sass gem can't handle CSS variables
  ...
  # config.active_job.queue_name_prefix = "radio_donations_production"
  ...
  # Allow the configured public host(s). APP_HOST is your custom domain
  ...
  if allowed_hosts.any?
    ...
    config.action_cable.allowed_request_origins =
      allowed_hosts.flat_map { |h| ["https://#{h}", "http://#{h}"] }
  end
end
